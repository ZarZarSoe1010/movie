      ...
      <div class="w-75 rounded me-2 bg-dark p-4">
        ...
        <div class="row ms-2">
          ...
          <c:url value="/admin/movie/add" var="addMovie"></c:url>
            <form action="${ addMovie }" method="post" class="text-white">
              <div class="row">
              	<div class="col">
              	  <div>
              ...
              <div class="row mt-2">
              	...
              	<div class="col">
              		...
              		<input type="text" name="tailer" class="form-control"/>
              	</div>
              </div>
               <div class="row mt-2">
              	<div class="col">
              		<label for="" class="form-label">Normal Download Link</label>
              		<input type="text" name="ndownload" class="form-control" />
              	</div>
              	<div class="col">
              		<label for="" class="form-label">Premium Download Link</label>
              		<input type="text" name="pdownload" class="form-control" />
              	</div>
              </div>
           	  <div class="row mt-2">
           		   <div class="col">
